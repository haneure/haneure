...
[![My Skills](https://skillicons.dev/icons?i=ts,nodejs,js,vue,react,nextjs,tailwind,redis,rabbitmq,laravel,php,html,css,vite,prisma,mysql,postgres,kotlin,py,go,cs,unity,docker,raspberrypi,kubernetes,grafana,cloudflare,aws)](https://skillicons.dev)
